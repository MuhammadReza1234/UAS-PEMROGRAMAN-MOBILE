...
public class BugattiFragment extends Fragment {
    ...
    private ImageView BugattiFragment;

    @SuppressLint("MissingInflatedId")
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_bugatti, container, false);

        BugattiFragment = view.findViewById(R.id.BugattiFragment);

        BugattiFragment.setOnClickListener(v -> playVideo("bugatti"));
